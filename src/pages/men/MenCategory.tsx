...
const MenCategory = () => {
    ...
    const products = getProductsByCategory('men', selectedCategory.toLowerCase());
    ...
    const handleCategoryChange = (newCategory: string) => {
        ...
        if (newCategory.toLowerCase() === 'all') {
            ...
            navigate(`/men/${newCategory.toLowerCase().replace(' ', '-')}`);
        }
    };
        ...
        <div className="pt-24 min-h-screen bg-white">
            <div className="max-w-screen-xl mx-auto px-4 py-8">
                <div className="flex justify-between items-center mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Men's {selectedCategory !== 'All' ? selectedCategory : 'Collection'}</h1>
            ...
            <SizeGuide isOpen={isSizeGuideOpen} onClose={() => setIsSizeGuideOpen(false)} category="men" />
        </div>
    );
};
