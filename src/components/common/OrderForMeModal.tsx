...
import { faTimes, faImage, faMicrophone, faSpinner, faPaperPlane } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent"
                                    rows={4}
                                    placeholder="Describe the item you want in detail (style, brand reference, etc.)"
                                    required
                                />
                            </div>
